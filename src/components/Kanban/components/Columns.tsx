...
const Column = ({ children, ...rest }: KanbanColumnProps) => {
  return <div {...rest}>{children}</div>
}

const Columns = ({ data }: KanbanColumnsProps) => {
  return (
                    ...
                    content={
                      ...
                      >
                        ...
                        <div className={styles['info-counts']}>
                          ...
                          <span>
                            <ReadingIcon width={17} height={17} /> 32 hours read
                            time
                          </span>
                        </div>
                      </div>
...
Columns.displayName = 'Kanban Columns'
